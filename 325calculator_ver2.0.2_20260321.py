# 最后编辑于2026/03/21 17:43 Ver2.0.3
# 修改了部分变量名称，修复了一些已知问题，优化了负数显示的文本错误，增加了重新游玩的功能

while True:
    try:
        print("输入一个数字，它能把任何数字变成325计算公式……")
        input_num = int(input("请输入一个绝对值小于1,000,000,000的整数（比如皱皮朋友的ID？）："))
